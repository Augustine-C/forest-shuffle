...
export class GameState {
    ...
    playCard(playerId: string, cardId: string, costCardIds: string[], targetTreeIndex?: number, targetSlot?: 'top' | 'bottom' | 'left' | 'right') {
        ...
        if (cardToPlay.type === 'split' && targetSlot) {
            ...
            if (targetSlot === 'top' && cardToPlay.top) requiredCost = cardToPlay.top.cost;
            else if (targetSlot === 'bottom' && cardToPlay.bottom) requiredCost = cardToPlay.bottom.cost;
            else if (targetSlot === 'left' && cardToPlay.left) requiredCost = cardToPlay.left.cost;
            else if (targetSlot === 'right' && cardToPlay.right) requiredCost = cardToPlay.right.cost;
            else {
