...
const en = {
  ...
  gameOver: 'Game Over!', pointCount: '{count} points', viewRules: 'View Rules', backHome: 'Back to Home', yourTurn: "It's YOUR Turn!", waitingFor: 'Waiting for {name}...', myScore: 'My score', currentScore: 'Your current score is {score}', deckCount: 'Deck: {count} cards', winterCount: 'Winter: {count}/3',
...
const zh: Record<TranslationKey, string> = {
  ...
  gameOver: '游戏结束！', pointCount: '{count} 分', viewRules: '查看规则', backHome: '返回首页', yourTurn: '轮到你了！', waitingFor: '等待 {name}…', myScore: '我的分数', currentScore: '你当前的分数为 {score}', deckCount: '牌库：{count} 张', winterCount: '冬季：{count}/3',
  ...
  drawOne: '抽 1 张牌', drawTwo: '抽 2 张牌', takeAndDraw: '拿取 {take} 张 + 抽取 {draw} 张', playSapling: '作为树苗打出', waitingPending: '等待当前待处理行动完成。', myHand: '我的手牌（{count}）', myForest: '我的森林', playerForest: '{name} 的森林', chooseForest: '选择要查看的森林', myForestTab: '我的森林', viewingOnly: '当前仅供查看——切换至“我的森林”才能放置卡牌。', noTrees: '还没有树，种下一棵吧！', emptyForest: '这片森林还是空的。', sapling: '树苗',
